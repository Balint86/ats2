...
export default function ElofeszitettBetonToronyPage() {
  const { t } = useLanguage();    
    ...
    return (
      <section style={{ padding: "32px 0" }}>
        ...
        items={[
          ...
          { label: t("elofeszitettbetontoronyTitle")}
        ]}
      />
        <h1>{t("elofeszitettbetontoronyTitle")}</h1>
        <p>{t("elofeszitettbetontoronyLong")}</p>
      </section>
    );
  }
